def main():
    ...
    def get_dragon_order():
        return {"Green Dragon": 0, "Red Dragon": 1, "Blue Dragon": 2, "Black Dragon": 3}

    order_of_dragons = get_dragon_order()

    for dragon in dragons:
        other_dragons = [d for d in dragons if d != dragon]

        other_dragons.sort(key=lambda d: order_of_dragons[d.name])
